...
OnChainWallet _$OnChainWalletFromJson(Map<String, dynamic> json) =>
    OnChainWallet(
      json['id'] as int,
      json['accountId'] as int,
      (json['balancePer'] as num).toDouble(),
...
Map<String, dynamic> _$OnChainWalletToJson(OnChainWallet instance) =>
    <String, dynamic>{
      'id': instance.id,
      'accountId': instance.accountId,
      'balancePer': instance.balancePer,
...
OnChainWalletList _$OnChainWalletListFromJson(Map<String, dynamic> json) =>
    OnChainWalletList(
      (json['list'] as List<dynamic>)
