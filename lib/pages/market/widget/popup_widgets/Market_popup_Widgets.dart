...
class Market_popup_Type_Widget extends StatefulWidget {

  Market_popup_Type_Widget({Key? key}) : super(key: key);

  @override
  _Market_popup_Type_Widget createState() => _Market_popup_Type_Widget();
}

class _Market_popup_Type_Widget extends State<Market_popup_Type_Widget> {
  bool SEDAN = false;
  bool SUV = false;
  bool OFF_ROAD = false;
  bool SPORTS = false;
...
class Market_popup_Grade_Widget extends StatefulWidget {

  Market_popup_Grade_Widget({Key? key}) : super(key: key);

  @override
  _Market_popup_Grade_Widget createState() => _Market_popup_Grade_Widget();
}

class _Market_popup_Grade_Widget extends State<Market_popup_Grade_Widget> {
